...
function App() {
  ...
  return (
    ...
    >
      <div className="bg-[#001219] min-h-screen py-8 flex flex-col justify-between">
        <div className="w-full max-w-5xl mx-auto rounded-lg px-4 py-3 text-white flex-1">
        ...
        <div className="text-white text-center py-4">
          Made with <span className="text-red-500">❤️</span> by Anmol
        </div>
      </div>
    </ToDoProvider>
  );
